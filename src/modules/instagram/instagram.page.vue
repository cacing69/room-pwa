...
const getHeight = computed(() =>
  data.value?.pages?.length == 1 && data.value?.pages.values.length <= 15
    ? "100vh"
    : "auto"
);
...
const {
  ...
  getNextPageParam: (lastPage: any, pages: any) =>
    lastPage.data.length == limit.value ? lastPage.meta.page + 1 : undefined,
